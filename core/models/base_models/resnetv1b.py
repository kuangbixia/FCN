...
class ResNetV1b(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, dilated=True, deep_stem=False,
                 zero_init_residual=False, norm_layer=nn.BatchNorm2d, local_rank=0):
        # fix bug: unexpected argument 'local_rank'
        # (from https://github.com/Tramac/awesome-semantic-segmentation-pytorch/issues/110#issuecomment-606355328)
